...
# Test model - the 2 lines we wrote modifiying the user model
...
# Registration form
    ...
    def test_registration_form_fails_wih_missing_password1(self):
        form = UserRegistrationForm({
            'email': 'test@test.com',
            'password1': 'letmein1',
            'password2': 'letmein3',
    ...
    def test_registration_form_fails_wih_missing_password2(self):
        form = UserRegistrationForm({
            'email': 'test@test.com',
            'password1': 'letmein1',
            # 'password2': 'letmein3',
        ...
        self.assertFalse(form.is_valid())
        self.assertRaisesMessage(forms.ValidationError,
                                 "Passwords do not match. Password confirmation is required",
                                 form.full_clean())

    def test_registration_form_fails_wih_missing_passwords(self):
        form = UserRegistrationForm({
            'email': 'test@test.com',
            # 'password1': 'letmein1',
            # 'password2': 'letmein3',
